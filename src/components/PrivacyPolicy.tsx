    ...
    <div className="min-h-screen ios-app-bg text-white/90 px-6 py-8 max-w-3xl mx-auto" style={{ paddingTop: 50 }}>
      ...
      <div className="space-y-6 text-sm leading-relaxed text-white/80">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>本地存储</strong>：您的账户、订单、收藏和偏好数据存储在浏览器本地（IndexedDB），确保离线可用</li>
            <li><strong>文件上传</strong>：管理员上传的图片文件会通过服务端保存，用于展示对应商品或戏服图片</li>
          </ul>
          <h3 className="text-sm font-semibold text-white/90 mt-3 mb-1">4.2 安全措施</h3>
          <ul className="list-disc pl-5 space-y-1">
            <li>全站 HTTPS 加密传输</li>
            <li>服务端接口权限控制，防止未授权访问</li>
      ...
      <div className="mt-10 pt-6 border-t border-white/10 text-center text-xs text-white/30">
        <p>© 2026 晋梆智绎 版权所有</p>
        <p className="mt-2">
          <a href="https://beian.miit.gov.cn/" target="_blank" rel="noreferrer" className="hover:text-amber-300">
            晋ICP备2026006293号-1
          </a>
        </p>
      </div>
